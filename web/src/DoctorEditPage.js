  ...
  renderDoctor() {
    return (
      <Card size="small" title={
        ...
        <Row style={{marginTop: "20px"}}>
          <Col style={{marginTop: "5px"}} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(i18next.t("general:Department"), i18next.t("general:Department - Tooltip"))} :
          </Col>
          <Col span={22}>
            <Input
        ...
        <Row style={{marginTop: "20px"}}>
          <Col style={{marginTop: "5px"}} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(i18next.t("general:AccessLevel"), i18next.t("general:AccessLevel - Tooltip"))} :
          </Col>
          <Col span={22}>
            <Input
        ...
        <Row style={{marginTop: "20px"}}>
          <Col style={{marginTop: "5px"}} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(i18next.t("general:HospitalName"), i18next.t("general:HospitalName - Tooltip"))} :
          </Col>
          <Col span={22}>
            <Input
