...
class DoctorListPage extends BaseListPage {
  ...
  newDoctor() {
    return {
      ...
      accessLevel: "", // Updated field
      canModify: false, // Updated field
      canDelete: false, // Updated field
      hospital: "",    // Renamed to match HospitalName
    };
  }
  ...
  renderTable(doctors) {
    const columns = [
      ...
      {
        title: i18next.t("general:AccessLevel"),
        dataIndex: "accessLevel",
        key: "accessLevel,
        sorter: (a, b) => a.hospital.localeCompare(b.hospital),
      },
      {
        title: i18next.t("general:HospitalName"),
